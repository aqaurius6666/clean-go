...
func SwaggerHandler(filenames ...string) gin.HandlerFunc {
	dataMapping := make(map[string][]byte)
	for _, filename := range filenames {
		bz, _ := files.ReadFile(filename)
		dataMapping[filename] = bz
	}
	...
	swaggerHandler := swaggerFiles.NewHandler()
